...
class SaveEmp(View):
    def post(self,request):
        ...
        try:
            ...
            return render(request,"addemp.html",{"msg":"Details already exist(email/contact/login/-any one matched with existing data)"})
        else:
...
class SaveFd(View):
    def post(self,request):
        ...
        try:
            ...
            return render(request,"addfd.html",{"msg":"Details already exist(email/contact/login/-any one matched with existing data)"})
        else:
